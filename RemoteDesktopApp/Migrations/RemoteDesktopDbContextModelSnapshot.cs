...
namespace RemoteDesktopApp.Migrations
{
    ...
    partial class RemoteDesktopDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneCall", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CallerPhoneNumber");

                    b.HasIndex("ReceiverId");

                    b.HasIndex("ReceiverPhoneNumber");

                    b.HasIndex("StartTime");

                    b.HasIndex("Status");

                    b.HasIndex("CallerId", "ReceiverId", "StartTime");

                    b.ToTable("PhoneCalls");
                });

            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AutoAnswerDelay")
                        .HasColumnType("int");

                    b.Property<bool>("AutoAnswerEnabled")
                        .HasColumnType("bit");

                    b.Property<bool>("CallForwardingEnabled")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ForwardToPhoneNumber")
                        .HasMaxLength(3)
                        .HasColumnType("nvarchar(3)");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.SmsMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.UnitCommunicationPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SourceUnitId", "TargetUnitId", "CommunicationType")
                        .IsUnique();

                    b.ToTable("UnitCommunicationPermissions");
                });

            modelBuilder.Entity("RemoteDesktopApp.Models.UnitLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnitLinks", t =>
                        {
                            t.HasCheckConstraint("CK_UnitLink_NoSelfLink", "[SourceUnitId] <> [TargetUnitId]");
                        });
                });
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPhoneActivity")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("PhoneNotificationsEnabled")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PhoneSoundEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneCall", b =>
                {
                    b.HasOne("RemoteDesktopApp.Models.User", "Caller")
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneContact", b =>
                {
                    b.HasOne("RemoteDesktopApp.Models.User", "ContactUser")
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.PhoneSettings", b =>
                {
                    b.HasOne("RemoteDesktopApp.Models.User", "User")
                        .WithOne("PhoneSettings")
                        .HasForeignKey("RemoteDesktopApp.Models.PhoneSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.SmsMessage", b =>
                {
                    b.HasOne("RemoteDesktopApp.Models.User", "Receiver")
                        .WithMany("ReceivedSmsMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RemoteDesktopApp.Models.User", "Sender")
                        .WithMany("SentSmsMessages")
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.Unit", b =>
                {
                    b.HasOne("RemoteDesktopApp.Models.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RemoteDesktopApp.Models.User", "Manager")
                        .WithMany()
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("RemoteDesktopApp.Models.Unit", "ParentUnit")
                        .WithMany("SubUnits")
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.UnitCommunicationPermission", b =>
                {
                    ...
                    b.HasOne("RemoteDesktopApp.Models.Unit", "SourceUnit")
                        .WithMany("CommunicationPermissions")
                        .HasForeignKey("SourceUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RemoteDesktopApp.Models.Unit", "TargetUnit")
                        .WithMany("AllowedCommunications")
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.UnitLink", b =>
                {
                    ...
                    b.HasOne("RemoteDesktopApp.Models.Unit", "SourceUnit")
                        .WithMany("LinkedUnits")
                        .HasForeignKey("SourceUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RemoteDesktopApp.Models.Unit", "TargetUnit")
                        .WithMany("LinkedByUnits")
                        .HasForeignKey("TargetUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.User", b =>
                {
                    ...
                    b.HasOne("RemoteDesktopApp.Models.Unit", "Unit")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.Unit", b =>
                {
                    b.Navigation("AllowedCommunications");

                    b.Navigation("CommunicationPermissions");

                    b.Navigation("LinkedByUnits");

                    b.Navigation("LinkedUnits");
            ...
            modelBuilder.Entity("RemoteDesktopApp.Models.User", b =>
                {
                    ...
                    b.Navigation("PhoneNotifications");

                    b.Navigation("PhoneSettings");
                    ...
                    b.Navigation("ReceivedSmsMessages");
